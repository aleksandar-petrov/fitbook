...
export class WorkoutPlanService {
    ...
    createWorkoutPlan(workoutPlanBindingModel: WorkoutPlanBindingModel) {
        ...
        return this.http.post('/api/workout-plans/create', workoutPlanBindingModel);

    }

    getLoggedInUserWorkoutPlans() {

        return this.http.get('/api/workout-plans/my');
    ...
    deleteMyWorkoutPlan(workoutPlanId: string) {
        ...
        return this.http.delete('/api/workout-plans/delete/' + workoutPlanId);

    }

    editMyWorkoutPlan(workoutPlanId: string, workoutPlanEditBindingModel: WorkoutPlan) {

        return this.http.put('/api/workout-plans/edit/' + workoutPlanId, workoutPlanEditBindingModel);

    }

    getAllPublicWorkoutPlans() {

        return this.http.get('/api/workout-plans/public/all');

    }

    getWorkoutPlanById(workoutPlanId: string) {

        return this.http.get('/api/workout-plans/' + workoutPlanId);

    }

    copyWorkoutPlanToMyWorkoutPlans(workoutPlanId: string) {

        return this.http.post('/api/workout-plans/copy/' + workoutPlanId, null);
    }
    ...
    addWorkoutFromMyWorkoutsToMyWorkoutPlan(workoutPlanId: string, workoutId: string) {
        ...
        return this.http.post('/api/workout-plans/add-workout/' + workoutPlanId, null, {params: params});

    }

    exportWorkoutPlanToExcel(workoutPlanId: string) {

        return this.http.get('/api/workout-plans/export/excel/' + workoutPlanId, {responseType: "blob"});
    }
