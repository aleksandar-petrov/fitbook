...
let AuthService = class AuthService {
    ...
    autoLogin() {
        ...
        const loadedUser = new _user_auth_model__WEBPACK_IMPORTED_MODULE_5__["UserAuthModel"](userData.userId, userData.role, userData.rememberMe, userData._token, new Date(userData._tokenExpirationDate));
        if (loadedUser.token) {
...
let SearchFoodComponent = class SearchFoodComponent {
    constructor(foodService, modalService) {
        ...
        this.foodService.fetchFoodDetailsByFoodId(foodId).subscribe((resp) => {
            ...
            for (const foodNutrient of foodNutrients) {
                switch (foodNutrient.nutrient.id) {
                    case 1003:
                        this.selectedFoodForModal.proteinPerHundred = foodNutrient.amount;
                        break;
                    case 1005:
                        this.selectedFoodForModal.carbohydratesPerHundred = foodNutrient.amount;
                        break;
                    case 1004:
                        this.selectedFoodForModal.fatsPerHundred = foodNutrient.amount;
                        break;
                }
            }
...
let MuscleSelectorComponent = class MuscleSelectorComponent {
    constructor() {
...
let SelectedWorkoutPlanComponent = class SelectedWorkoutPlanComponent {
    ...
    deleteWorkoutExercise(workoutPlanId, workoutId) {
...
let EditSelectedWorkoutComponent = class EditSelectedWorkoutComponent {
    constructor(workoutService, route) {
        this.workoutService = workoutService;
        this.route = route;
    }
    ngOnInit() {
...
EditSelectedWorkoutComponent.ctorParameters = () => [
...
let WorkoutDetailsComponent = class WorkoutDetailsComponent {
    constructor(workoutService, route, modalService, router, constantViewPipe) {
        this.workoutService = workoutService;
        this.route = route;
        this.modalService = modalService;
        this.router = router;
    ...
    fetchWorkoutDetails() {
        this.workoutService.fetchPublicWorkoutById(this.workoutId).subscribe((workout) => {
            if (workout) {
...
let WorkoutPlanDetailsComponent = class WorkoutPlanDetailsComponent {
    constructor(workoutPlanService, route, modalService, router, constantViewPipe) {
        this.workoutPlanService = workoutPlanService;
        this.route = route;
        this.modalService = modalService;
        this.router = router;
...
let WorkoutService = class WorkoutService {
    ...
    createExercise(workoutCreateModel) {
