...
let AdminGuard = class AdminGuard {
    ...
    canActivate(route, router) {
        return this.authService.user.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => {
            ...
            const hasNeededRole = user.role === 'ROLE_ADMIN' || user.role === 'ROLE_ROOT_ADMIN';
            if (hasNeededRole) {
                return true;
            }
...
let AuthService = class AuthService {
    ...
    autoLogin() {
        ...
        const loadedUser = new _user_auth_model__WEBPACK_IMPORTED_MODULE_5__["UserAuthModel"](userData.userId, JSON.parse(atob((userData._token.replace('Bearer: ', '').split('.')[1]))).role, userData.rememberMe, userData._token, new Date(userData._tokenExpirationDate));
        if (loadedUser.token) {
    ...
    handleAuthentication(token, rememberMe) {
        ...
        const user = new _user_auth_model__WEBPACK_IMPORTED_MODULE_5__["UserAuthModel"](userId, userRole, rememberMe, token, expirationDate);
        this.user.next(user);
        this.autoLogout(tokenExpiresInMS);
        const localStorageUser = Object.assign({}, user);
        delete localStorageUser.role;
        localStorage.setItem('userData', JSON.stringify(localStorageUser));
    }
    isUserModerator(userRole) {
...
let ModeratorGuard = class ModeratorGuard {
    constructor(authService, router, authGuard) {
        this.authService = authService;
        this.router = router;
...
class UserAuthModel {
    constructor(userId, role, rememberMe, _token, _tokenExpirationDate) {
        this.userId = userId;
        this.role = role;
...
let CommentDatePipe = class CommentDatePipe {
    constructor() {
        this.MONTH_NAMES = [
...
let CommentService = class CommentService {
    ...
    commentWorkout(workoutId, comment) {
    ...
    commentDietPlan(dietPlanId, comment) {
    ...
    deleteDietPlanComment(commentId) {
    ...
    commentWorkoutPlan(workoutPlanId, comment) {
    ...
    deleteWorkoutPlanComment(commentId) {
...
let AllDietPlansComponent = class AllDietPlansComponent {
    ...
    open(content, dietPlanId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title', size: "lg", scrollable: true }).result.then((result) => {
            this.loading = true;
            this.dietPlanService.copyDietPlanToMyDietPlans(dietPlanId).subscribe((dietPlan) => {
                this.loading = false;
...
let DietPlanCardComponent = class DietPlanCardComponent {
    ...
    copyToMyDietPlansHandler(id) {
        this.modalOpen.emit(id);
    }
    onLikeHandler() {
        this.dietPlanService.likeDietPlan(this.dietPlan.id).subscribe((dietPlan) => {
            this.dietPlan = dietPlan;
        });
    }
};
DietPlanCardComponent.ctorParameters = () => [
    { type: _diet_plan_service__WEBPACK_IMPORTED_MODULE_2__["DietPlanService"] }
];
...
let DietPlanDetailsComponent = class DietPlanDetailsComponent {
    ...
    fetchDietPlanDetails() {
        this.loading = true;
        this.dietPlanService.getDietPlanById(this.dietPlanId).subscribe((dietPlan) => {
            if (dietPlan) {
                this.dietPlan = dietPlan;
    ...
    open(content) {
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title', size: "lg" }).result.then((result) => {
            this.loading = true;
            this.dietPlanService.copyDietPlanToMyDietPlans(this.dietPlanId).subscribe((dietPlan) => {
                this.loading = false;
                this.router.navigate(['my-diet-plans/', dietPlan.id]);
            });
        }, (reason) => {
    ...
    exportToExcelHandler() {
        this.dietPlanService.exportDietPlanToExcel(this.dietPlanId).subscribe((blob) => {
    ...
    onPostHandler() {
        this.commentService.commentDietPlan(this.dietPlan.id, this.commentBindingModel).subscribe((comment) => {
            this.commentBindingModel = new _comment_comment_binding_model__WEBPACK_IMPORTED_MODULE_6__["CommentBindingModel"]();
...
DietPlanDetailsComponent.ctorParameters = () => [
...
let DietPlanService = class DietPlanService {
    ...
    createDietPlan(dietPlanBindingModel) {
    ...
    editMyDietPlan(dietPlanId, dietPlanEditBindingModel) {
    ...
    copyDietPlanToMyDietPlans(dietPlanId) {
    ...
    addMealFromMyMealsToMyDietPlan(dietPlanId, mealId) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().append('mealId', mealId);
    ...
    exportDietPlanToExcel(dietPlanId) {
...
DietPlanService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
MyDietPlansComponent.ctorParameters = () => [
...
let NoSelectedDietPlanComponent = class NoSelectedDietPlanComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SelectedDietPlanComponent = class SelectedDietPlanComponent {
    constructor(route, dietPlanService, mealService, router, constantViewPipe, modalService, userService) {
        this.route = route;
        this.dietPlanService = dietPlanService;
    ...
    ngOnInit() {
        ...
        this.mealService.getLoggedInUserMeals().subscribe((meals) => {
            if (meals) {
    ...
    onMealDeleteHandler(mealId, orderIndex) {
    ...
    onSaveHandler() {
        this.loading = true;
        this.dietPlanService.editMyDietPlan(this.dietPlanId, this.editDietPlanBindingModel).subscribe((dietPlan) => {
            this.selectedDietPlan = dietPlan;
            this.makeChartDataForMacroNutrients;
            this.loading = false;
        });
    ...
    exportToExcelHandler() {
        this.dietPlanService.exportDietPlanToExcel(this.selectedDietPlan.id).subscribe((blob) => {
            const url = window.URL.createObjectURL(blob);
            const anchor = document.createElement("a");
...
SelectedDietPlanComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _diet_plan_service__WEBPACK_IMPORTED_MODULE_5__["DietPlanService"] },
...
let AllExercisesComponent = class AllExercisesComponent {
    ...
    fetchUserWorkouts() {
        this.workoutService.getLoggedInUserWorkouts().subscribe((workouts) => {
    ...
    open(content, exerciseId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            ...
            this.workoutService.addWorkoutExerciseToWorkout(this.workoutExerciseBindingModel, this.selectedWorkoutId).subscribe((workout) => {
...
class WorkoutExerciseBindingModel {
    constructor() {
        this.reps = 1;
        this.sets = 1;
...
let CreateExerciseComponent = class CreateExerciseComponent {
    constructor(exerciseService, router, titleService) {
        this.exerciseService = exerciseService;
        this.router = router;
    ...
    setAssistingMuscleGroupsToBindingModel() {
    ...
    handleFileInput(files, chooseFileLabel) {
        const file = files[0];
        const pattern = /image-*/;
    ...
    handleAssistingMuscleGroupsChange(event) {
    ...
    handleMajorMuscleGroupChange(event) {
        const muscleType = event.target.value;
        this.assistingMuscleGroupsSelected[muscleType] = false;
    }
};
CreateExerciseComponent.ctorParameters = () => [
    { type: _exercise_service__WEBPACK_IMPORTED_MODULE_3__["ExerciseService"] },
...
let ExerciseDetailsComponent = class ExerciseDetailsComponent {
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe((params) => {
            if (params['id']) {
                this.exerciseService.getExerciseById(params['id']).subscribe((exercise) => {
...
ExerciseDetailsComponent.ctorParameters = () => [
...
class SelectedMuscleGroupsModel {
}
...
let AllFoodsComponent = class AllFoodsComponent {
    ...
    open(content, foodId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            ...
            this.mealService.addMealFoodToMeal(this.mealFoodBindingModel, this.selectedMealId).subscribe((meal) => {
...
let FoodService = class FoodService {
    ...
    fetchFoodsFromDataCentralByFoodName(foodName) {
    ...
    fetchFoodDetailsByFoodId(foodId) {
...
let SearchFoodComponent = class SearchFoodComponent {
    ...
    onSearchHandler() {
        this.foodService.fetchFoodsFromDataCentralByFoodName(this.searchFoodName).subscribe((resp) => {
            this.foodSearchResults = [];
            this.page = 1;
            resp.foods.forEach(food => {
                const foodInfo = new _food_model__WEBPACK_IMPORTED_MODULE_3__["Food"]();
    ...
    open(content, foodId) {
        this.foodService.fetchFoodDetailsByFoodId(foodId).subscribe((resp) => {
            this.selectedFoodForModal = new _food_model__WEBPACK_IMPORTED_MODULE_3__["Food"]();
            this.foodBindingModel = new _food_binding_model__WEBPACK_IMPORTED_MODULE_5__["FoodBindingModel"]();
...
let GetConstantViewNamePipe = class GetConstantViewNamePipe {
    transform(camelCaseString, ...args) {
...
let CreateFitnessProfileComponent = class CreateFitnessProfileComponent {
    ...
    onWeightGoalChange(eventTarget) {
...
class FitnessProfileBindingModel {
    constructor() {
...
let FitnessProfileGuard = class FitnessProfileGuard {
    constructor(userService, router) {
        this.userService = userService;
        this.router = router;
    }
...
FitnessProfileGuard.ctorParameters = () => [
    { type: _user_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
];
...
let AllMealsComponent = class AllMealsComponent {
    ...
    open(content, mealId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title', size: 'lg' }).result.then((result) => {
            this.mealService.copyMealToLoggedUserMeals(mealId).subscribe((meal) => {
                this.router.navigate(['my-meals', meal.id]);
            });
        }, (reason) => {
        });
...
let MealCardComponent = class MealCardComponent {
    ...
    copyToMyMealsHandler(id) {
        this.modalOpen.emit(id);
    }
    onLikeHandler() {
        this.mealService.likeMeal(this.meal.id).subscribe((meal) => {
            this.meal = meal;
        });
    }
};
MealCardComponent.ctorParameters = () => [
...
let MealDetailsComponent = class MealDetailsComponent {
    ...
    fetchMealDetails() {
        this.mealService.fetchMealById(this.mealId).subscribe((meal) => {
            if (meal) {
                this.meal = meal;
    ...
    open(content) {
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title', size: 'lg' }).result.then((result) => {
            this.mealService.copyMealToLoggedUserMeals(this.mealId).subscribe((meal) => {
                this.router.navigate(['my-meals', meal.id]);
            });
        }, (reason) => {
        });
    ...
    onPostHandler() {
        this.commentService.commentMeal(this.meal.id, this.commentBindingModel).subscribe((comment) => {
            this.commentBindingModel = new _comment_comment_binding_model__WEBPACK_IMPORTED_MODULE_6__["CommentBindingModel"]();
...
MealDetailsComponent.ctorParameters = () => [
...
let MealService = class MealService {
    ...
    addMealFoodToMeal(mealFoodBindingModel, mealId) {
    ...
    deleteMealFoodFromMeal(mealId, foodId) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().append('foodId', foodId);
    ...
    editMealById(mealId, mealBindingModel) {
    ...
    copyMealToLoggedUserMeals(mealId) {
...
MyMealsComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
...
let NoSelectedMealComponent = class NoSelectedMealComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SelectedMealComponent = class SelectedMealComponent {
    constructor(route, mealService, router, modalService) {
        this.route = route;
        this.mealService = mealService;
        this.router = router;
        this.modalService = modalService;
    ...
    onMealFoodDeleteHandler(mealId, foodId) {
    ...
    deleteMealExercise(mealId, foodId) {
        this.mealService.deleteMealFoodFromMeal(mealId, foodId).subscribe((meal) => {
            this.selectedMeal = meal;
        });
    }
    onEditMealFoodHandler(food) {
    ...
    onSaveHandler() {
        this.mealService.editMealById(this.mealId, this.editMealBindingModel).subscribe((meal) => {
...
let GuestNavbarComponent = class GuestNavbarComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoggedNavbarComponent = class LoggedNavbarComponent {
    ...
    ngOnInit() {
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"])).subscribe((event) => {
            const url = event.url;
...
let UserService = class UserService {
    ...
    updateFitnessProfileOnLoggedInUser(fitnessProfileBindingModel) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
        });
    ...
    setFitnessProfileInLocalStorage(boolean) {
        localStorage.setItem('fp', String(boolean));
    }
    getLoggedUserFitnessProfileCondition() {
...
let AllWorkoutPlansComponent = class AllWorkoutPlansComponent {
    ...
    open(content, workoutPlanId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            this.workoutPlanService.copyWorkoutPlanToMyWorkoutPlans(workoutPlanId).subscribe((workoutPlan) => {
...
let MyWorkoutPlansComponent = class MyWorkoutPlansComponent {
    ...
    fetchWorkoutsPlans() {
        this.workoutPlanService.getLoggedInUserWorkoutPlans().subscribe((workoutPlans) => {
            this.workoutPlans = workoutPlans;
        });
    }
    onWorkoutPlanButtonClick(id) {
...
MyWorkoutPlansComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
    { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
...
let NoSelectedWorkoutPlanComponent = class NoSelectedWorkoutPlanComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SelectedWorkoutPlanComponent = class SelectedWorkoutPlanComponent {
    constructor(route, workoutPlanService, workoutService, router, constantViewPipe, modalService) {
        this.route = route;
        this.workoutPlanService = workoutPlanService;
        this.workoutService = workoutService;
        this.router = router;
    ...
    onWorkoutDeleteHandler(workoutId, orderIndex) {
    ...
    onSaveHandler() {
        this.workoutPlanService.editMyWorkoutPlan(this.workoutPlanId, this.editWorkoutPlanBindingModel).subscribe((workoutPlan) => {
            this.selectedWorkoutPlan = workoutPlan;
            this.calculateExercisesSets();
        });
        this.router.navigate(['./'], { relativeTo: this.route });
    ...
    exportToExcelHandler() {
        this.workoutPlanService.exportWorkoutPlanToExcel(this.selectedWorkoutPlan.id).subscribe((blob) => {
            const url = window.URL.createObjectURL(blob);
            const anchor = document.createElement("a");
...
SelectedWorkoutPlanComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
...
let WorkoutPlanCardComponent = class WorkoutPlanCardComponent {
    ...
    copyToMyWorkoutPlansHandler(id) {
        this.modalOpen.emit(id);
    }
    ...
    onLikeHandler() {
        this.workoutPlanService.likeWorkoutPlan(this.workoutPlan.id).subscribe((workoutPlan) => {
            this.workoutPlan = workoutPlan;
        });
    }
};
WorkoutPlanCardComponent.ctorParameters = () => [
...
let WorkoutPlanDetailsComponent = class WorkoutPlanDetailsComponent {
    ...
    fetchWorkoutPlanDetails() {
        this.workoutPlanService.getWorkoutPlanById(this.workoutPlanId).subscribe((workoutPlan) => {
            if (workoutPlan) {
                this.workoutPlan = workoutPlan;
    ...
    open(content) {
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            this.workoutPlanService.copyWorkoutPlanToMyWorkoutPlans(this.workoutPlanId).subscribe((workoutPlan) => {
                this.router.navigate(['my-workout-plans/', workoutPlan.id]);
            });
        }, (reason) => {
        });
    ...
    exportToExcelHandler() {
        this.workoutPlanService.exportWorkoutPlanToExcel(this.workoutPlanId).subscribe((blob) => {
            const url = window.URL.createObjectURL(blob);
            const anchor = document.createElement("a");
    ...
    onPostHandler() {
        this.commentService.commentWorkoutPlan(this.workoutPlan.id, this.commentBindingModel).subscribe((comment) => {
            this.commentBindingModel = new _comment_comment_binding_model__WEBPACK_IMPORTED_MODULE_7__["CommentBindingModel"]();
...
WorkoutPlanDetailsComponent.ctorParameters = () => [
    { type: _workout_plan_service__WEBPACK_IMPORTED_MODULE_6__["WorkoutPlanService"] },
...
let WorkoutPlanService = class WorkoutPlanService {
    ...
    createWorkoutPlan(workoutPlanBindingModel) {
    ...
    deleteMyWorkoutPlan(workoutPlanId) {
    ...
    editMyWorkoutPlan(workoutPlanId, workoutPlanEditBindingModel) {
    ...
    copyWorkoutPlanToMyWorkoutPlans(workoutPlanId) {
    ...
    addWorkoutFromMyWorkoutsToMyWorkoutPlan(workoutPlanId, workoutId) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().append('workoutId', workoutId);
    ...
    exportWorkoutPlanToExcel(workoutPlanId) {
...
WorkoutPlanService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let AllWorkoutsComponent = class AllWorkoutsComponent {
    ...
    open(content, workoutId) {
        ...
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            this.workoutService.copyWorkoutToLoggedUserWorkouts(workoutId).subscribe((workout) => {
                this.router.navigate(['my-workouts', workout.id]);
            });
        }, (reason) => {
        });
...
let MyWorkoutsComponent = class MyWorkoutsComponent {
    ...
    onWorkoutButtonClick(workoutId) {
...
MyWorkoutsComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
...
let NoSelectedWorkoutComponent = class NoSelectedWorkoutComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SelectedWorkoutComponent = class SelectedWorkoutComponent {
    constructor(route, workoutService, router, constantViewPipe, modalService) {
        this.route = route;
        this.workoutService = workoutService;
        this.router = router;
        this.constantViewPipe = constantViewPipe;
    ...
    onWorkoutExerciseDeleteHandler(workoutId, exerciseId) {
    ...
    deleteWorkoutExercise(workoutId, exerciseId) {
        this.workoutService.deleteWorkoutExerciseFromWorkout(workoutId, exerciseId).subscribe((workout) => {
            this.selectedWorkout = workout;
        });
    }
    onSaveHandler() {
        this.workoutService.editWorkoutById(this.workoutId, this.editWorkoutBindingModel).subscribe((workout) => {
    ...
    onWorkoutDeleteHandler(workoutId) {
...
SelectedWorkoutComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
...
let WorkoutCardComponent = class WorkoutCardComponent {
    ...
    copyToMyWorkoutsHandler(id) {
        this.modalOpen.emit(id);
    }
    onLikeHandler() {
        this.workoutService.likeWorkout(this.workout.id).subscribe((workout) => {
            this.workout = workout;
        });
    }
};
WorkoutCardComponent.ctorParameters = () => [
    { type: _workout_service__WEBPACK_IMPORTED_MODULE_2__["WorkoutService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let WorkoutDetailsComponent = class WorkoutDetailsComponent {
    ...
    fetchWorkoutDetails() {
        this.workoutService.fetchWorkoutById(this.workoutId).subscribe((workout) => {
            if (workout) {
                this.workout = workout;
                console.log(workout);
                this.workout
    ...
    open(content) {
        this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
            this.workoutService.copyWorkoutToLoggedUserWorkouts(this.workoutId).subscribe((workout) => {
                this.router.navigate(['my-workouts', workout.id]);
            });
        }, (reason) => {
        });
    ...
    onPostHandler() {
        this.commentService.commentWorkout(this.workout.id, this.commentBindingModel).subscribe((comment) => {
            this.commentBindingModel = new _comment_comment_binding_model__WEBPACK_IMPORTED_MODULE_8__["CommentBindingModel"]();
...
WorkoutDetailsComponent.ctorParameters = () => [
...
let WorkoutService = class WorkoutService {
    ...
    createWorkout(workoutCreateModel) {
    ...
    addWorkoutExerciseToWorkout(workoutExerciseBindingModel, workoutId) {
    ...
    deleteWorkoutExerciseFromWorkout(workoutId, exerciseId) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().append('exerciseId', exerciseId);
    ...
    editWorkoutById(workoutId, workoutBindingModel) {
    ...
    copyWorkoutToLoggedUserWorkouts(workoutId) {
